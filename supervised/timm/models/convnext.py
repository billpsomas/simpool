...
class ConvNeXt(nn.Module):
    ...
    def __init__(
        ...
        self.head = nn.Sequential(OrderedDict([
                ('global_pool', SelectAdaptivePool2d(dim=self.num_features, pool_type=global_pool, gamma=gamma)),
    ...
    def reset_classifier(self, num_classes=0, global_pool=None):
        if global_pool is not None:
            self.head.global_pool = SelectAdaptivePool2d(dim=self.num_features, pool_type=global_pool, gamma=gamma)
