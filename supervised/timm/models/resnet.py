...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.global_pool, self.fc = create_classifier(self.num_features, self.num_classes, pool_type=global_pool, gamma=gamma)
    ...
    def reset_classifier(self, num_classes, global_pool='avg', gamma=None):
        self.num_classes = num_classes
        self.global_pool, self.fc = create_classifier(self.num_features, self.num_classes, pool_type=global_pool, gamma=gamma)
